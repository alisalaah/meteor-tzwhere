...
this.tzNameAt = function() { return wrap(tzNameAt); };
this.tzDateAt = function() { return wrap(dateAt); };
this.tzDateIn = function() { return wrap(dateIn); };
this.tzOffset = function() { return wrap(tzOffsetAt); };
